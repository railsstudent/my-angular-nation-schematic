import { Rule, SchematicContext, Tree, apply, url, chain, template, mergeWith, move, branchAndMerge, SchematicsException,  } 
...
export function createStructure(_options: any): Rule {
  return (tree: Tree, _context: SchematicContext) => {
    ...
    if (!angularConfig) {
      throw new SchematicsException('You are not in an Angular project, goodbye!');
    }
